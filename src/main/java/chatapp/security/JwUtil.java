...
public class JwUtil {
    ...
    // Clave secreta más segura (debe tener al menos 256 bits)
    private final String SECRET = "secreto_super_seguro_para_mazachat_con_suficiente_longitud_para_hmac_sha256";
